...
- **Academy Sidebar**: Interactive agent training and promotion interface integrated into Academy page, Business Unit home pages, and Project detail pages. Displays promotion progress, evidence pack links, and allows one-click agent advancement. Features dual-column layout on BU/Project pages with main content and sidebar. Includes error handling for failed promotions and proper cache invalidation to keep data in sync.
