 ...
 * Usage:
 *   const plugin = require('./tailwind.podglass.plugin');
 *   // in tailwind.config.js:
 *   plugins: [require('./tailwind.podglass.plugin')],
 */
const plugin = require('tailwindcss/plugin');

module.exports = plugin(function({ addUtilities, addComponents, e, theme }) {
  const rails = {
  ...
  addUtilities(rails, ['responsive']);
  addUtilities(glass, ['responsive']);
});
