...
const ImagesAdmin: React.FC = () => {
  ...
  const onDrop = (e: React.DragEvent<HTMLDivElement>) => { e.preventDefault(); if (e.dataTransfer.files?.length) setFiles(e.dataTransfer.files); };
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <section className="space-y-3">
        ...
        <div onDragOver={e=>e.preventDefault()} onDrop={onDrop} className="border-dashed border-2 rounded p-6 text-center">
